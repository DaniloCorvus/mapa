...
<div class="ml-auto d-flex align-items-center secondary-menu text-center m-2">
    ...
    <a href="javascript:void(0)" class="tooltip-wrapper" data-toggle="modal" data-placement="top"
        data-target="#modalMacroProcesoRegister" title="Registrar">
        <i class="fa fa-edit btn btn-icon text-success"></i>
    </a>

    <h5 class="m-2">
        <i class="fa fa-group"></i> MacroProcesos
    </h5>
        ...
        <div class="card card-statistics">
            <div class="card-body">
                <div class="export-table-wrapper table-responsive">
                    <table class="table table-bordered " style="color:black" id="dataTablemacroprocesos" width="100%"
                        cellspacing="0">
                        <thead class="thead">
                            <tr>
                                <th>Categoria</th>
...
@include('administrativo.macroprocesos.formUpdate')
@include('administrativo.macroprocesos.formRegister')
...
@push('scripts')
<script src="{{ asset('/apis/apiMacroProceso.js') }}"></script>
@endpush